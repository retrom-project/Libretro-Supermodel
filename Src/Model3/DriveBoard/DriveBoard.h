...
protected:
  ...
  // Return the number of Z80 cycles in one Model 3 video frame.
  ...
  bool m_allowNMIInterrupts; // True if board has enabled NMI interrupts
  ...
  int m_nmiTimerVal;      // Cycles remaining until the next CTC-driven NMI
